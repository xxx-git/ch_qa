...
weight_change = {'mg': 0.0000001, 'g': 0.001, 'kg': 1, 't': 1000, 'catty': 0.5, 'liang': 0.1,
                 'lb': 0.4536}  # 所有重量单位向kg转换
area_unit = {u'平方公里': 'square_km', u'平方千米': 'square_km', u'平方米': 'square_m', u'平方分米': 'square_dm', u'平方厘米': 'square_cm',
             u'平方毫米': 'square_mm', u'公顷': 'ha', u'公亩': 'are', u'亩': 'mu', u'英亩': 'acre'}
area_change = {'square_km': 1, 'square_m': 1e-6, 'square_dm': 1e-8, 'square_cm': 1e-10, 'square_mm': 1e-12, 'ha': 0.01,
               'are': 0.0001, 'mu': 0.0006667, 'acre': 0.0040469}
...
currency_unit = {u'美金': 'dollar', u'美元': 'dollar', u'美分': 'cent', u'港元': 'HK_dollar', u'港币': 'HK_dollar',
                 u'澳元': 'au_dollar', u'澳币': 'au_dollar', u'加元': 'can_dollar', u'加拿大元': 'can_dollar', u'英镑': 'pound',
                 u'欧元': 'Euro', u'人民币': 'rmb', u'元': 'yuan'}
currency_change = {'dollar': 6.64, 'cent': 0.0664, 'HK_dollar': 0.85, 'au_dollar': 5.08, 'can_dollar': 5.17,
                   'pound': 8.72, 'Euro': 7.73, 'rmb': 1, 'yuan': 1}
...
def chinese2number(str_value):
    ...
    while i < len(str_value) and (
                str_value[i:end] in chinese_num or str_value[i:end] in unit_dict or str_value[i:end] in tran_ch):
...
def unify_date(date_str):
    '''将所有的日期类型的属性值进行规范'''
    chinese_num = {u'零': '0', u'一': '1', u'二': '2', u'三': '3', u'四': '4', u'五': '5', u'六': '6', u'七': '7', u'八': '8',
                   u'九': '9'}
    tran_ch = {u'壹': '1', u'贰': '2', u'叁': '3', u'肆': '4', u'伍': '5', u'陆': '6', u'柒': '7', u'捌': '8', u'玖': '9'}
    i = 0
    end = i + 1
...
def unify_value(pro, old_value):
    ...
    if pro.find(date_pro[0]) != -1 or pro.find(date_pro[1]) != -1 or pro.find(date_pro[2]) != -1 or pro.find(
            date_pro[3]) != -1:
